  ...
  client.ev.on('messages.upsert', async (m) => {
    try {
      ...
      const body = 
        ...
        (mtype === 'buttonsResponseMessage') && mek.message.buttonsResponseMessage.selectedButtonId ? mek.message.buttonsResponseMessage.selectedButtonId :
        (mtype === 'listResponseMessage') && mek.message.listResponseMessage.singleSelectReply.selectedRowId ? mek.message.listResponseMessage.singleSelectReply.selectedRowId :
        (mtype === 'templateButtonReplyMessage') && mek.message.templateButtonReplyMessage.selectedId ? mek.message.templateButtonReplyMessage.selectedId :
      ...
      const budy = (typeof mek.message.conversation === 'string') 
        ? mek.message.conversation 
        : ''

      mek.msg = mek.message
      mek.sender = mek.key.fromMe 
      ...
      mek.text = body
      mek.command = body.startsWith(global.prefix) 
